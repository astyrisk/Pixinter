...
var app = (function () {
    ...
    let getRadius = (i, j) => Math.sqrt(Math.pow(i.x - j.x, 2) + Math.pow(i.y - j.y, 2));
    function getColor(p, point) {
        let color;
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$4, 151, 0, 5105);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function drawCircle(start, end, color, ctx) {
    		...
    		for (let y = yStart; y < yEnd; y++) for (let x = xStart; x < xEnd; x++) {
    			if (getRadius(start, { x, y }) <= r) drawn.push({ x, y });
    		}
    	...
    	function fillColor(p, color, ctx) {
    		...
    		for (let done = 0; done < drawn.length; done++) {
    			for (let { dx, dy } of around) {
    				...
    				if (x >= 0 && x < w && y >= 0 && y < h && getColor(picture, { x, y }) == targetColor && !drawn.some(p => p.x == x && p.y == y)) {
    					drawn.push({ x, y });
    				}
    			}
    		}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<PictureCanvas> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('pictureObj' in $$props) pictureObj = $$props.pictureObj;
    ...
    const file$3 = "src/Compononets/Settings.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-tjh1b0");
    			add_location(input, file$3, 41, 2, 933);
    			...
    			attr_dev(img, "class", "svelte-tjh1b0");
    			add_location(img, file$3, 42, 2, 1043);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $config;
    	validate_store(pictureHistory, 'pictureHistory');
    	component_subscribe($$self, pictureHistory, $$value => $$invalidate(6, $pictureHistory = $$value));
    	validate_store(picture, 'picture');
    	component_subscribe($$self, picture, $$value => $$invalidate(7, $picture = $$value));
    	validate_store(config, 'config');
    	component_subscribe($$self, config, $$value => $$invalidate(0, $config = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    ...
    const file$2 = "src/Compononets/Tool.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "" + (/*tool*/ ctx[8] + " img" + " svelte-4fuobc"));
    			attr_dev(img, "alt", /*tool*/ ctx[8]);
    			attr_dev(img, "width", "30px");
    			add_location(img, file$2, 41, 12, 1228);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:8) {#each tools as tool}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "" + (/*shape*/ ctx[5] + " img" + " svelte-4fuobc"));
    			attr_dev(img, "alt", /*shape*/ ctx[5]);
    			attr_dev(img, "width", "30px");
    			add_location(img, file$2, 50, 12, 1638);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:8) {#each shapes as shape}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 39, 4, 1166);
    			...
    			add_location(img0, file$2, 45, 4, 1449);
    			attr_dev(div1, "class", "shapes");
    			add_location(div1, file$2, 48, 4, 1573);
    			...
    			add_location(img1, file$2, 54, 4, 1866);
    			attr_dev(main, "class", "svelte-4fuobc");
    			add_location(main, file$2, 37, 0, 1137);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 75, 0, 2182);
    			attr_dev(button1, "class", "load svelte-7ehrj4");
    			add_location(button1, file$1, 76, 0, 2241);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function pictureFromImage(image) {
    		...
    		for (let j = 0; j < 60; j++) for (let i = 0; i < 90; i++) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<File> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-prpbq1");
    			add_location(h1, file, 7, 1, 244);
    			attr_dev(div0, "class", "canvas svelte-prpbq1");
    			add_location(div0, file, 8, 1, 265);
    			attr_dev(div1, "class", "tool svelte-prpbq1");
    			add_location(div1, file, 12, 2, 337);
    			attr_dev(div2, "class", "tools svelte-prpbq1");
    			add_location(div2, file, 11, 1, 315);
    			attr_dev(div3, "class", "file svelte-prpbq1");
    			add_location(div3, file, 15, 1, 392);
    			add_location(main, file, 6, 0, 236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ PictureCanvas, Color: Settings, Tool, File });
    	return [];
    }
