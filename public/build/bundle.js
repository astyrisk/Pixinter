...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$4, 141, 0, 4700);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<PictureCanvas> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 20, 2, 398);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 41, 12, 1227);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "width", "30px");
    			add_location(img, file$2, 50, 12, 1633);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 39, 4, 1165);
    			...
    			add_location(img0, file$2, 45, 4, 1444);
    			attr_dev(div1, "class", "shapes");
    			add_location(div1, file$2, 48, 4, 1568);
    			...
    			add_location(img1, file$2, 54, 4, 1857);
    			attr_dev(main, "class", "svelte-4fuobc");
    			add_location(main, file$2, 37, 0, 1136);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 74, 0, 2162);
    			attr_dev(button1, "class", "load svelte-7ehrj4");
    			add_location(button1, file$1, 75, 0, 2221);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
