...
var app = (function () {
    ...
    const config = writable({ color: "#000000", tool: "pen" });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 37, 4, 1024);
    			add_location(div, file$3, 36, 0, 1014);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			img1 = element("img");
    			if (!src_url_equal(img0.src, img0_src_value = "../../icons/pen-tool.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "pixel");
    			attr_dev(img0, "width", "30px");
    			attr_dev(img0, "height", "30px");
    			add_location(img0, file$1, 34, 8, 828);
    			attr_dev(div0, "class", "pen svelte-4rx8ao");
    			add_location(div0, file$1, 33, 4, 749);
    			if (!src_url_equal(img1.src, img1_src_value = "../../icons/eraser.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "pixel");
    			attr_dev(img1, "width", "30px");
    			attr_dev(img1, "height", "30px");
    			add_location(img1, file$1, 38, 8, 1005);
    			attr_dev(div1, "class", "eraser svelte-4rx8ao");
    			add_location(div1, file$1, 37, 4, 920);
    			attr_dev(div2, "class", "tools svelte-4rx8ao");
    			add_location(div2, file$1, 32, 0, 725);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", /*handlePenClick*/ ctx[0], false, false, false),
    					listen_dev(div0, "keydown", handleKeyDown, false, false, false),
    					listen_dev(div1, "click", /*handleEraserClick*/ ctx[1], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('pen' in $$props) pen = $$props.pen;
    		if ('eraser' in $$props) eraser = $$props.eraser;
    	};
    	...
    	return [handlePenClick, handleEraserClick];
    }
