...
var app = (function () {
    ...
    const file$1 = "src/PictureCanvas.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$1, 44, 4, 1218);
    			add_location(div, file$1, 43, 0, 1208);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(canvas_1, "click", /*handleMouseclick*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleMouseclick(event) {
    		...
    		let pointerPosition = getPointerPosition(event, canvas);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "canvas svelte-xhmi0x");
    			add_location(div, file, 4, 1, 89);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, div);
    			mount_component(picturecanvas, div, null);
    			current = true;
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ PictureCanvas });
    	return [];
    }
