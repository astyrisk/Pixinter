...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$3, 161, 0, 5091);
    		},
    ...
    function getPointerPosition(p, domNode) {
    	...
    	return {
    		x: Math.floor((p.clientX - rect.left) / scale),
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function fillColor(p, color, ctx) {
    		...
    		let targetColor = picture.getColor(p);
    		let drawn = [p];
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<PictureCanvas> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('getRadius' in $$props) getRadius = $$props.getRadius;
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 20, 2, 398);
    			attr_dev(div, "class", "color-selector svelte-k0dpbo");
    			add_location(div, file$2, 19, 0, 366);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 41, 12, 1227);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "width", "30px");
    			add_location(img, file$1, 50, 12, 1633);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 39, 4, 1165);
    			...
    			add_location(img0, file$1, 45, 4, 1444);
    			attr_dev(div1, "class", "shapes");
    			add_location(div1, file$1, 48, 4, 1568);
    			...
    			add_location(img1, file$1, 54, 4, 1857);
    			attr_dev(main, "class", "svelte-4fuobc");
    			add_location(main, file$1, 37, 0, 1136);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
